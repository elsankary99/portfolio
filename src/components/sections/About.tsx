    ...
    <section id="about" className="relative py-24 sm:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-16">
          ...
          >
            <div className="grid grid-cols-2 gap-6 p-8 rounded-2xl bg-overlay/[0.03] border border-overlay/[0.06]">
            ...
            <div className="relative p-8 rounded-2xl overflow-hidden bg-gradient-to-br from-primary-600/10 via-purple-600/10 to-blue-600/10 border border-overlay/[0.06]">
